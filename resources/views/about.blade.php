    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 wow fadeInRight animated" data-wow-delay=".5s">
                <img src="{{asset('assets/img/dd2.jpg')}}" />
            </div>
        </div>
    </div>
    <!-- =============== container end =============== -->
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 wow fadeInDown animated" data-wow-delay=".1s">
                <div class="timg"><img src="{{asset('assets/img/team-img1.jpg')}}"/></div>
                <div class="t-box">
                    <h3>MOHD SUBHAN</h3>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 wow fadeInUp animated" data-wow-delay=".2s">
                <div class="timg"><img src="{{asset('assets/img/team-img2.jpg')}}"/></div>
                <div class="t-box">
                    <h3>Mohd Rahman</h3>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 wow fadeInDown animated" data-wow-delay=".3s">
                <div class="timg"><img src="{{asset('assets/img/team-img3.jpg')}}"/></div>
                <div class="t-box">
                    <h3>ZEENAT SUBHAN</h3>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 wow fadeInUp animated" data-wow-delay=".4s">
                <div class="timg"><img src="{{asset('assets/img/team-img4.jpg')}}"/></div>
                <div class="t-box">
                    <h3>MOHD SAIF</h3>
